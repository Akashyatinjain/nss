  ...
  return (
    <section className="py-20 lg:py-28 bg-nss-navy text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="p-8 sm:p-12 lg:p-14 rounded-3xl bg-nss-navy-light/60 backdrop-blur-xl border border-white/15 shadow-glass-lg">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            {/* Left Col: Flagship Editorial Spotlight (6 Cols) */}
            <div className="lg:col-span-6 flex flex-col items-start">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 text-xs font-bold uppercase tracking-widest mb-4">
              ...
              <p className="mt-5 text-slate-300 text-base leading-relaxed font-body font-light">
              ...
              <div className="mt-8 w-full flex flex-col gap-4 p-5 rounded-2xl bg-white/5 border border-white/10">
                <div>
                  <div className="flex items-center justify-between text-xs font-semibold mb-1.5">
                    ...
                    <span className="text-emerald-400 font-bold font-mono">88.5% Completed</span>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-3 pt-2 text-center border-t border-white/10">
                  <div>
                    <div className="text-xl font-bold text-white font-heading">6,200+</div>
                    <div className="text-[11px] text-slate-400">Trees Planted</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-emerald-400 font-heading">92%</div>
                    <div className="text-[11px] text-slate-400">Survival Rate</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-white font-heading">140+</div>
                    <div className="text-[11px] text-slate-400">Volunteers Active</div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] sm:aspect-[16/11] border border-white/20 shadow-2xl group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-nss-navy-dark via-transparent to-transparent opacity-80" />
