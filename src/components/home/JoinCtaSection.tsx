...
export function JoinCtaSection() {
  return (
    <section className="relative py-20 lg:py-28 bg-radial-navy text-white overflow-hidden">
      ...
      <div className="absolute -left-20 top-1/2 -translate-y-1/2 pointer-events-none opacity-20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-nss-red/20 border border-nss-red/40 text-xs font-bold uppercase tracking-widest text-red-200 mb-6">
          <Sparkles className="w-3.5 h-3.5" />
          Enrollment Open For All Branches & Years
        </div>

        <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold font-heading tracking-tight text-white leading-tight">
          READY TO SERVE?
        </h2>

        <p className="mt-4 text-xl sm:text-2xl text-slate-300 font-serif italic max-w-2xl mx-auto">
          “Your time. Your skills. Your community.”
        </p>

        <p className="mt-4 text-sm sm:text-base text-slate-400 max-w-xl mx-auto font-body">
